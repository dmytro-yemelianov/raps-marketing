...
\fancyhead[C]{\color{rapsblue}\textbf{RAPS v4.11.0}}
\fancyhead[R]{\color{rapsgray}\small Page \thepage\ of \pageref{LastPage}}
\fancyfoot[L]{\color{rapsgray}\small Document v1.8 | February 2026}
...
\begin{center}
\textbf{Need Help?}\\[2mm]
📧 support@rapscli.xyz | 💬 Discord: discord.gg/raps | 🌐 rapscli.xyz\\[2mm]
This document is part of RAPS Professional Documentation Suite v4.11.0
\end{center}
\end{tcolorbox}
